...
<div class="container">
    ...
    <form role="form" action="BilgiyiAl.jsp" method="post">
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="Lütfen emailinizi giriniz.">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="tecrube" name="tecrube"
                   placeholder="Kaç yıllık tecrübelisiniz?">
